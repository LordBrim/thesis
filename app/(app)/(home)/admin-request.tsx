  ...
  useEffect(() => {
    const fetchTicketRequests = async () => {
      try {
        ...
        const querySnapshot = await getDocs(collection(db, "ticketRequest"));
        ...
        {ticketRequests.map((request) => (
          <View key={request.id} style={styles.requestItem}>
            ...
            <View style={styles.requestDetails}>
              ...
              <Text style={styles.value}>{request.selectedBloodType}</Text>
            </View>
            <View style={styles.requestDetails}>
              <Text style={styles.label}>Relationship:</Text>
              <Text style={styles.value}>{request.selectedRelationship}</Text>
            </View>
